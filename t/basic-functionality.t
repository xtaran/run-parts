...
# List files
eq_or_diff([$rp->list], [qw[bar.bla foo script.pl]], "Returns list of files in array context");
eq_or_diff(''.$rp->list, "bar.bla\nfoo\nscript.pl\n", "Returns list of files in string context");

# List executable files
eq_or_diff([$rp->test], [qw[script.pl]], "Returns list of executables in array context");
